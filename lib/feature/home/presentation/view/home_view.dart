        ...
        return Scaffold(
          ...
          floatingActionButton: ScaleTransition(
            ...
            child: FloatingActionButton.extended(
              ...
              icon: Icon(Icons.keyboard_arrow_up_rounded, color: Theme.of(context).colorScheme.surface,),

              label: Text("Top", style: TextStyle(color: Theme.of(context).colorScheme.surface),),
            ),
          ),
