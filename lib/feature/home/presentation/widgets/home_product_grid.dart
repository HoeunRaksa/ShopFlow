...
class HomeProductGrid extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    /// ✅ WATCH ONCE (NOT inside builder)
    final favoriteState = ref.watch(favoriteControllerProvider);
    final favoriteProducts = favoriteState.value ?? [];

    /// ⚡ FAST LOOKUP (O(1))
    final favIds = favoriteProducts.map((e) => e.id).toSet();
      ...
      delegate: SliverChildBuilderDelegate(
          ...
          return AnimatedProductCard(
            ...
            child: InkWell(
              ...
              onTap: () {
                ref
                    .read(ownerPushVerificationControllerProvider.notifier)
                    .state = true;
